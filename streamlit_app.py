...
if (len(ingredients_list) > 0) & (len(name_on_smoothie) > 0):
    ingredients_string = ''
    ...
    for fruit_chosen in ingredients_list:
        ...
        fv_res = requests.get('https://fruityvice.com/api/fruit/' + search_on)
        fv_df = st.dataframe(fv_res.json(), use_container_width=True)
